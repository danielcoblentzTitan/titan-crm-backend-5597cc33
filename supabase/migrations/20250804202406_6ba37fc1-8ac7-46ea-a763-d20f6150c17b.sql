-- Create 7 invoices based on the payment schedule for the Nick and Rachael Fulford project
...
-- Draw 1 (20%): Due on project start date (permit approved)
(
...
-- Draw 2 (20%): Due 7 days before project start (lumber delivery)
(
  (SELECT customer_id FROM projects WHERE id = 'c0d89370-cdfa-4cd8-9ecf-2eb2413429ea'),
  'c0d89370-cdfa-4cd8-9ecf-2eb2413429ea',
  'INV-002-2025',
