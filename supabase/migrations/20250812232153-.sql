-- Create function to send new price request notification
    ...
    PERFORM
      net.http_post(
        url := concat(
          ...
          '/functions/v1/send-price-request-notifications'
        ),
...
-- Create function to send status change notification
...
-- Set up the required settings for the HTTP calls
ALTER DATABASE postgres SET "app.settings.supabase_url" TO 'https://rviwdobaeyhnwzkinefj.supabase.co';
ALTER DATABASE postgres SET "app.settings.service_role_key" TO 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJ2aXdkb2JhZXlobnd6a2luZWZqIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MTAzNTYyNSwiZXhwIjoyMDY2NjExNjI1fQ.aHXvWWKOxGxnpHyXXWKsIyXaR8cK0fLgP9pGdCf5Sko';