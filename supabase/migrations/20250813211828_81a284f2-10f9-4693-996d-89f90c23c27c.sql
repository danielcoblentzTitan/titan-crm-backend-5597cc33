-- Add unique constraint on jurisdiction name and then add Maryland counties
ALTER TABLE permit_jurisdictions ADD CONSTRAINT permit_jurisdictions_name_unique UNIQUE (name);

-- Add Maryland Eastern Shore counties
